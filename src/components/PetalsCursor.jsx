  ...
  useEffect(() => {
    ...
    class Petal {
      ...
      reset(scattered = false) {
        ...
        if (speedRand < 0.28) {
          this.speedType = 'fast';
          this.followStrength = 0.0009 + Math.random() * 0.0005;
          this.maxSpeed = 9 + Math.random() * 2.5;
          this.drag = 0.93;
          ...
          this.maxSpeed = 5.5 + Math.random() * 2;
          this.drag = 0.91;
          ...
          this.speedType = 'slow';
          this.followStrength = 0.00015 + Math.random() * 0.00015;
          this.maxSpeed = 3.2 + Math.random() * 1.5;
          this.drag = 0.89;
